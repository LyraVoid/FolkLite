...
基于 [MIUIX](https://github.com/YuKongA/miuix) 组件库重新打造的 Root 管理工具，在保留 FolkPatch 全部核心功能的同时，带来原生 MIUI/HyperOS 风格的视觉体验与交互设计。
...
- [x] UI 框架基于 [MIUIX](https://github.com/YuKongA/miuix)
...
1. **下载安装：**
   从 [发布页面](https://github.com/matsuzaka-yuki/FolkLite/releases/latest) 下载最新版安装包
...
- [FolkPatch](https://github.com/matsuzaka-yuki/FolkPatch/) - 上游项目
...
- [Sukisu-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra) - 参考部分界面设计
